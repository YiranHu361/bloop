            ...
            Section("Network Activity") {
                HStack(spacing: 12) {
                    ...
                    VStack(alignment: .leading, spacing: 4) {
                        ...
                        Text("This app works completely offline. We don't send any data to servers, collect analytics, or track your usage.")
                            .font(AppTypography.caption1)
                            .foregroundColor(AppColors.secondaryLabel)
                    }
                }
            ...
            Section("Third-Party Services") {
                HStack(spacing: 12) {
                    ...
                    VStack(alignment: .leading, spacing: 4) {
                        ...
                        Text("We don't use any analytics, advertising, or tracking SDKs. Only Apple's native frameworks are used.")
                            .font(AppTypography.caption1)
                            .foregroundColor(AppColors.secondaryLabel)
                    }
                }
